...
for shifted = 1:60
    load(['../../early_delay/regul_train_test_' num2str(shifted) '.mat']);
    W_tt_early = W_tt;
    componentsToUse_tt_early = componentsToUse_tt;
    load(['../regul_train_test_' num2str(shifted) '.mat']);
    W_tt = W_tt_early;
    componentsToUse_tt = componentsToUse_tt_early;
    ...
    for cross = 2
        ...
        for tests = 1:ntests
            ...
            correct_task(tests,:) = squeeze(correct_task_tmp);
        end
