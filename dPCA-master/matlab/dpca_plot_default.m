...
%             text(1.2, f, ['Stimulus ' num2str(f)])
            if numOfStimuli == 2
                if f == 1
                    ...
                    text(1.2, f, 'Preferred')
                end
            elseif numOfStimuli == 6
                if f == 1
                    text(1.2, f, 'direction1')
                elseif f == 2
                    text(1.2, f, 'direction2')
                elseif f == 3
                    text(1.2, f, 'direction3')
                elseif f == 4
                    text(1.2, f, 'direction4')
                elseif f == 5
                    text(1.2, f, 'direction5')
                elseif f == 6
                    text(1.2, f, 'direction6')
                end
            end
        end
...
%             text(1.2, f, ['Stimulus ' num2str(f)])
        ...
        text(1.2, -2, 'No-look task')
        text(1.2, -3, 'Look task')
...
elseif ndims(data) == 3
    ...
    for f = 1:size(data,2)
        plot(time, squeeze(data(1,f,:)),'color', colors(f,:), 'LineWidth', 2); hold on;
    end
