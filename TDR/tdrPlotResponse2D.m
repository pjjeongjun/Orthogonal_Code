function [sdata,handles] = tdrPlotResponse2D(data,plotpars)
...
% The figure
if isempty(plotpars.bootstrapN)
...
for ivar = 1:nvar
    ...
    sdata{ivar,1} = rx; sdata{ivar,2} = ry;
end
...
if isempty(plotpars.bootstrapN)
    ...
    if isfield(plotpars,'legend')
        legend(plotpars.legend,'Location','southeast');
    end
end